 ...
 */
public class Matrix{
    private static int p0[] = new int[]{ 15, 10,  0, -6, 17};
    private static int p1[] = new int[]{ 3, 14,  8,  9,  2};
    private static int p2[] = new int[]{ 1,  5, 14, 20, -3};
    private static int p3[] = new int[]{ 7, 19, 10,  2,  0};
...
//        Критерий Гурвица
        ...
        double Hurwitz = maxD(h);
        System.out.println("Hurwitz = " + Hurwitz);
